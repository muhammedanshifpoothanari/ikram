...
"[project]/app/api/bills/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const bills = await db.collection("bills").find({}).sort({
            date: -1
        }).toArray();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fb6ab0d1._.js.map